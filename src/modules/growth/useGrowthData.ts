...
function usePaperAnalytics(logbook: MarkLogbookEntry[]) {
  return useMemo(() => {
    ...
    // Bolt optimization: Compare ISO date strings ('YYYY-MM-DD') directly instead of parsing
    // with `new Date(str).getTime()`, avoiding unnecessary Date object allocations.
