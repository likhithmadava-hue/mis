...
export default function EntryRow({
  ...
  return (
    ...
    >
      ...
      <td
        className="py-2.5 px-3 text-muted-foreground max-w-[160px] truncate"
        title={entry.chapter}
      >
        {entry.chapter || "—"}
      </td>
      <td className="py-2.5 px-3">
        <span
          className={`text-[9px] font-bold px-2 py-0.5 rounded-md border whitespace-nowrap ${REASON_BADGE[entry.mistake_reason]}`}
        >
      ...
      <td className="py-2.5 px-3">
        <span
          className={`text-[9px] font-bold px-2 py-0.5 rounded-md border ${DIFFICULTY_BADGE[entry.difficulty]}`}
        >
          {entry.difficulty}
        </span>
      </td>
      ...
      <td
        className="py-2.5 px-3 text-muted-foreground max-w-[240px] truncate"
        title={entry.notes}
      >
        {entry.notes || "—"}
      </td>
