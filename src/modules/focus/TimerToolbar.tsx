      ...
      <div className="w-full flex flex-wrap items-center justify-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-background border border-border text-muted-foreground hover:text-primary hover:border-primary/40 focus-visible:ring-2 focus-visible:ring-primary/50 outline-none transition-colors"
          >
          ...
          <button
            ...
            className={`p-2 rounded-xl border transition-colors focus-visible:ring-2 focus-visible:ring-primary/50 outline-none ${
              showSettings
