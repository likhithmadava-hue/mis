...
Everything the app _does_ is in this folder.

## Files here

| File        | What it does                                                                                                                                               |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `main.tsx`  | The entry point. It finds the empty `<div id="root">` in `index.html` and tells preact to draw the app inside it. You'll rarely touch this.                |
