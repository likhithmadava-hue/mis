...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::db_add_journal_entry,
            commands::db_update_journal_entry,
            ...
            commands::st_site_categories,
            commands::st_site_labels,
            commands::st_set_site_category,
            commands::st_clear_site_category,
